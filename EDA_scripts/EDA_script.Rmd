...
knitr::opts_knit$set(root.dir = 'C:/Users/Jamie/Downloads/DataFiles')
...
seasons <- read.csv('/kaggle/input/Seasons.csv')
rsdr <- read.csv('/kaggle/input/RegularSeasonDetailedResults.csv')
tdr <- read.csv('/kaggle/input/TourneyDetailedResults.csv')
Tseeds <- read.csv('/kaggle/input/TourneySeeds.csv')
Tslots <- read.csv('/kaggle/input/TourneySlots.csv')
```
